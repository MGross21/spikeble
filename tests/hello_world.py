...
from spike.lib.messages import BaseMessage

TMessage = TypeVar("TMessage", bound="BaseMessage")

import spike.lib.cobs as cobs
from spike.lib.messages import *
from spike.lib.crc import crc
...
EXAMPLE_PROGRAM = Path("__test.py").read_bytes()
